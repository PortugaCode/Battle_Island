...
public class Database_hur : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        itemList.Add(new ItemData_hur(false, 101, "1레벨 군용조끼", false, ItemData_hur.ItemType.armor, ItemData_hur.UsingType.Wearable));
        itemList.Add(new ItemData_hur(false, 102, "2레벨 군용조끼", false, ItemData_hur.ItemType.armor, ItemData_hur.UsingType.Wearable));
        itemList.Add(new ItemData_hur(false, 103, "3레벨 군용조끼 ", false, ItemData_hur.ItemType.armor, ItemData_hur.UsingType.Wearable));
        itemList.Add(new ItemData_hur(false, 104, "1레벨 배낭", false, ItemData_hur.ItemType.bag, ItemData_hur.UsingType.Wearable));
        itemList.Add(new ItemData_hur(false, 105, "2레벨 배낭", false, ItemData_hur.ItemType.bag, ItemData_hur.UsingType.Wearable));
        itemList.Add(new ItemData_hur(false, 106, "3레벨 배낭", false, ItemData_hur.ItemType.bag, ItemData_hur.UsingType.Wearable));
